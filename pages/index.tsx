...
export default function Home() {
  ...
  function scrollToBottom() {
    if (meassageListRef.current) {
      meassageListRef.current.scrollTop =
        meassageListRef.current.scrollHeight + 1000;
    }
  }
  ...
  return (
    <main className="flex flex-col p-4 w-full max-3-3xl m-auto">
      <h1 className="text-4xl font-bold text-center mb-4">
        Chat {connectionCount}
      </h1>
      <ol className="" ref={meassageListRef}>
        {message.map((m) => {
          return (
            <li
